...
$data = mysqli_query($database,"SELECT bank_akun.id, bank_akun.jenis_transaksi, bank_akun.nominal1 AS nominal_terkirim, bank_akun.rekening, bank_akun.nominal, bank_akun.inquiri, bank_akun.date_updated, kas_kecil.id, kas_kecil.jenis_transaksi, kas_kecil.jenis_kas, kas_kecil.rekening, kas_kecil.nominal, kas_kecil.inquiri, kas_kecil.create_date, kas_kecil.jenis_transaksi, kas_kecil.nominal AS nominal_diterima, kas_besar.id, kas_besar.jenis_transaksi, kas_besar.jenis_kas, kas_besar.rekening, kas_besar.nominal, kas_besar.inquiri, kas_besar.create_date, kas_besar.nominal AS nominal_diterima FROM bank_akun, kas_kecil, kas_besar WHERE bank_akun.rekening=kas_kecil.rekening AND bank_akun.rekening=kas_besar.rekening");
