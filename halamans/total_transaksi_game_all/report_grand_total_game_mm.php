...
$id=1;
// $rekening='rekening'; 
$data1 = mysqli_query($database,"SELECT id, jenis_transaksi, jenis_kas, rekening, nominal, inquiri, create_date FROM game_mm GROUP BY create_date");
...
<p>
    <a href="halamans/cetak_report/cetak_report_grand_total_game_mm.php" class="btn btn-success btn-lg">
