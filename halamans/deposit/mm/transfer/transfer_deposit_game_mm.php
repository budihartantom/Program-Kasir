...
if(isset($_POST['simpan'])){
    ...
    // $sql4="INSERT INTO penghutang SET jenis_kas='$jenis_kas', rekening='$rekening', nominal='$nominal', inquiri='$inquiri', saldo='$hasil', now='$now'";
  ...
  $sql2= "INSERT INTO bank_akun VALUES('', '$jenis_transaksi', NULL,'$rekening','$nominal','$hasil', '$inquiri', '$now')";

  // $sql2= "INSERT INTO bank_hutang VALUES('','$id_penghutang',NULL,'$nominal','$hasil','$inquiri','$now')";

// $sql4= "INSERT INTO bank_akun_back_up VALUES('','$jenis_transaksi', '$jenis_kas', '$rekening', 'deposit', '$inquiri', '$now')";


  // $sql4= "INSERT INTO bank_akun_back_up SET
  ...
  $sql3= "INSERT INTO transaksi_bank_akun_depo VALUES('','$jenis_transaksi', '$jenis_kas','$rekening','$nominal','$inquiri', '$now')";
...
<!-- 
                  <button type="submit" name="simpan" class="btn btn-success mr-2" onclick="return confirm('Apakah Anda Ingin Mencetaknya?')? window.open('http://192.168.1.10/program_kasir/detail_histori_bank.php?rekening=<?php// echo $d['rekening']; ?>'): void(0);">Deposit</button> -->
