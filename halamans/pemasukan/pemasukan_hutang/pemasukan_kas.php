...
if($_POST['jenis_kas']==1){
   ...
   $sql2= "INSERT INTO kas_kecil VALUES('', '$jenis_pemasukan','$jenis_kas','$rekening','$nominal','$inquiri', '$now')";

    $sql3= "INSERT INTO pemasukan VALUES('', '$jenis_pemasukan','$jenis_kas','$nominal','$rekening','$keterangan','$inquiri', '$now')";
   ...
   $sql4= "INSERT INTO kas_besar VALUES('', '$jenis_pemasukan','$jenis_kas','$rekening','$nominal','$inquiri', '$now')";
   $sql5= "INSERT INTO pemasukan VALUES('', '$jenis_pemasukan','$jenis_kas','$nominal','$rekening','$keterangan','$inquiri', '$now')";
 ...
 //  $sql= "INSERT INTO pemasukan VALUES('', '$jenis_pemasukan','$nominal','$rekening','$keterangan','$inquiri', '$now')";
...
<body>
          ...
          <table>
            ...
            <?php
include 'halamans\pilih_menu_pemasukan.php'
?>
                    <div class="row">
