...
$data = mysqli_query($database,"SELECT bank_akun.id, bank_akun.jenis_transaksi, bank_akun.nominal1 AS nominal_terkirim, bank_akun.rekening, bank_akun.nominal, bank_akun.inquiri, bank_akun.date_updated, bank_hutang.id, bank_hutang.id_penghutang, bank_hutang.nominal, bank_hutang.nominal1, bank_hutang.nominal1 AS nominal_diterima, bank_hutang.inquiri, bank_hutang.date_updated FROM bank_akun INNER JOIN bank_hutang ON bank_akun.rekening=bank_hutang.id_penghutang");
