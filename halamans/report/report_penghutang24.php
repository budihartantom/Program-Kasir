...
$data = mysqli_query($database,"SELECT penghutang.id_penghutang,  penghutang.nominal, penghutang.date_updated, transaksi_bank_hutang_depo.id_penghutang, transaksi_bank_hutang_depo.nominal, transaksi_bank_hutang_depo.date_updated, sum(transaksi_bank_hutang_depo.nominal) AS total_deposit from penghutang, transaksi_bank_hutang_depo  WHERE penghutang.id_penghutang=transaksi_bank_hutang_depo.id_penghutang GROUP BY penghutang.id_penghutang DESC");
