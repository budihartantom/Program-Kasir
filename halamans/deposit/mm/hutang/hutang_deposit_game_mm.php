...
//  $id_penghutang='id_penghutang'; 
//  $data = mysqli_query($database,"SELECT id_penghutang, nominal, nominal1, saldo, date_updated, SUM(nominal) AS total_withdraw, SUM(nominal1) AS total_deposit, SUM(saldo) AS total_saldo FROM bank_hutang GROUP BY id_penghutang ASC");
...
echo "<script>";
    echo " alert('Berhasil!! HORE!!');       
        window.location.href='http://192.168.1.10/program_kasir/detail_histori_penghutang.php?id_penghutang=$id_penghutang';
            ...
            // echo '<script>
            //       alert("Data Deposit Gagal di tambah"");
            //    </script>';
     ...
     // else ($database->query($sql2))
     //    {
     // else  ($database->query($sql3))
     //    {    

        // echo '<script>
        //           alert(" Anda Ingin Mencetak Tagihan Anda?");
        //           window.location.href="index.php?home";
        //        </script>';   
...
<!-- <a href="detail_histori_penghutang.php?id_penghutang=<?php// echo $d['id_penghutang']; ?>" onclick="return confirm();" class="btn btn-success mr-2">Deposit</a> -->


      <!-- <a href="detail_histori_penghutang.php?id_penghutang=<?php// echo $d['id_penghutang']; ?>" class="btn btn-success mr-2">Deposit</a> -->

      <!-- <a href="detail_histori_penghutang.php?id_penghutang=<?php //echo $d['id_penghutang'];?>" onClick="return konfirmasi()"/><button type="submit" name="simpan" class="btn btn-success mr-2" id="hasil">Deposit</button></a> -->

               


             <!-- <a href="detail_histori_penghutang.php?id_penghutang=<?php //echo $d['id_penghutang']; ?>" class="btn btn-success mr-2" onclick="return deleteconfig()">Deposit</a><br/><br/>
 -->
...
function konfirmasi()
{
tanya = confirm("Anda Yakin Ingin Mencetak Tagihan Anda ?");
if (tanya == true) return true;
else return false;
}</script> -->
    <!-- <script>
      function konfirmasi(){
        var konfirmasi = confirm("Anda Yakin Igin Mencetak Tagihan Anda ?");
        var text = "";
