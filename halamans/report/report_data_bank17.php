...
$id='id'; 
$data = mysqli_query($database,"SELECT transaksi_bank_akun_depo.id,  transaksi_bank_akun_depo.rekening, transaksi_bank_akun_depo.nominal, transaksi_bank_akun_depo.inquiri, transaksi_bank_akun_depo.date_updated, sum(transaksi_bank_akun_depo.nominal) AS total_deposit, transaksi_bank_akun_with.id,  transaksi_bank_akun_with.rekening, transaksi_bank_akun_with.nominal, transaksi_bank_akun_with.inquiri, transaksi_bank_akun_with.date_updated, sum(transaksi_bank_akun_with.nominal) AS total_withdraw from transaksi_bank_akun_depo, transaksi_bank_akun_with WHERE transaksi_bank_akun_depo.rekening = transaksi_bank_akun_with.rekening GROUP BY transaksi_bank_akun_depo.rekening DESC");
