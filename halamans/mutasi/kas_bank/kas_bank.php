...
if(isset($_POST['simpan'])){
  ...
  $sql= "INSERT INTO kas_kecil VALUES('', '$jenis_kas', '$rekening', NULL, '$nominal','$inquiri', '$now')";

 $sql1= "INSERT INTO bank_akun VALUES('', '$jenis_kas', NULL, '$rekening','$nominal','$hasil', 'deposit', '$now')";
...
$database->query($sql1);
   ...
   $sql2= "INSERT INTO kas_besar VALUES('', '$jenis_kas', '$rekening', NULL,'$nominal','$inquiri', '$now')";

   $sql3= "INSERT INTO bank_akun VALUES('', '$jenis_kas', NULL, '$rekening', '$nominal', '$hasil', 'deposit', '$now')";
