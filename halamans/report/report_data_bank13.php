...
$id='id'; 
$data = mysqli_query($database,"SELECT bank_account.id,  bank_account.id_bank, bank_account.account_name, bank_account.account_number, bank_account.date_updated, transaksi_bank_akun_depo.id,  transaksi_bank_akun_depo.rekening, transaksi_bank_akun_depo.nominal, transaksi_bank_akun_depo.inquiri, transaksi_bank_akun_depo.date_updated, sum(transaksi_bank_akun_depo.nominal) AS total_deposit from bank_account, transaksi_bank_akun_depo  WHERE bank_account.id=transaksi_bank_akun_depo.rekening GROUP BY bank_account.id DESC");
