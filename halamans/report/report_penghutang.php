...
$data = mysqli_query($database,"SELECT id_penghutang, nominal, nominal1, saldo, date_updated, SUM(nominal) AS total_withdraw, SUM(nominal1) AS total_deposit, SUM(saldo) AS total_saldo FROM bank_hutang WHERE id_penghutang!= 1 AND id_penghutang!=2 AND id_penghutang NOT LIKE 'B00%' GROUP BY id_penghutang ");
 ...
 -->
        ...
        <!--        <td><?php//s echo @rupiah($d['nominal']); ?></td> -->
            ...
            <td><?php echo @rupiah($d['total_saldo']= $d['total_deposit']-$d['total_withdraw']); ?></td>
               ...
               <td><a href="detail_histori_penghutang.php?id_penghutang=<?php echo $d['id_penghutang']; ?>" class="fa fa-search">Detail Transaksi</a></td>
                </tr>
                </tr>
