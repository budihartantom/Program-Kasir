...
function format_ribuan ($nilai){
  ...
  $nominal=0;
  $sqlTampil1= "SELECT id, jenis_transaksi, jenis_kas, rekening, nominal, inquiri, create_date, SUM(nominal) AS nominal from bank_akun WHERE rekening='B0003' AND inquiri='deposit'";
