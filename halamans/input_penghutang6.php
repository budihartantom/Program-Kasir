...
$cek = mysqli_num_rows(mysqli_query($database,"SELECT * FROM penghutang WHERE id_penghutang='$id_penghutang'"));
    ...
    mysqli_query($database,"INSERT INTO penghutang(id_penghutang)
    ...
    mysqli_query($database,"INSERT INTO transaksi_bank_hutang_depo(id_penghutang)
    VALUES ('','$id_penghutang', NULL , NULL , NULL , '$now')");
   ...
   $cek3 = mysqli_num_rows(mysqli_query($database,"SELECT * FROM transaksi_bank_hutang_with WHERE id_penghutang='$id_penghutang'"));
    ...
    mysqli_query($database,"INSERT INTO transaksi_bank_hutang_with(id_penghutang)
    VALUES ('','$id_penghutang', NULL , NULL , NULL , '$now')");

     $cek4 = mysqli_num_rows(mysqli_query($database,"SELECT * FROM bank_hutang WHERE id_penghutang='$id_penghutang'"));
    if ($cek4 > 0){
    echo "<script>window.alert('nama yang anda masukan sudah ada')
    window.location='index.php'</script>";
    }else{
    mysqli_query($database,"INSERT INTO bank(id_penghutang)
    VALUES ('','$id_penghutang', NULL , NULL , NULL , '$now')");
