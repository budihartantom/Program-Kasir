...
<html>
    ...
    <body>
		<div class="content">
			...
			<br></br>
			<br></br>
			<h2>Withdraw Mickey Mouse</h2>
			<h4>Silahkan pilih menu untuk penginputan</h4>
			<form name="lompat">
			<select name="menu">
			<option value="?withdraw_game_mm">Kas</option>
			<option value="?transfer_withdraw_game_mm">Transfer</option>
			
			<option value="?hutang_withdraw_game_mm">Hutang</option>
			</select>
