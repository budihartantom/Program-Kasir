...
if(isset($_POST['simpan'])){
   ...
   $sql2= "INSERT INTO pengeluaran_game_mm VALUES('', '$jenis_pengeluaran','$jenis_kas','$nominal','$rekening','$keterangan','$inquiri', '$now')";
  ...
  //  $database->query($sql3);
   ...
   $sql4= "INSERT INTO pengeluaran_game_bk VALUES('', '$jenis_pengeluaran','$jenis_kas','$jenis_game','$nominal','$rekening','$keterangan','$inquiri', '$now')";
  //  $sql5= "INSERT INTO game_bk VALUES('', '$jenis_pengeluaran','$jenis_kas','$rekening','$nominal','$inquiri', '$now')";
  ...
  //  $database->query($sql5);
   ...
   $sql6= "INSERT INTO pengeluaran_game_slot VALUES('', '$jenis_pengeluaran','$jenis_kas','$jenis_game','$nominal','$rekening','$keterangan','$inquiri', '$now')";
  ...
  //  $database->query($sql7);
   ...
   $sql8= "INSERT INTO pengeluaran_game_dingdong VALUES('', '$jenis_pengeluaran','$jenis_kas','$jenis_game','$nominal','$rekening','$keterangan','$inquiri', '$now')";
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             ...
                             <?php
$sql2="SELECT * FROM kategori_tr_bank where id='6' or id='8' ORDER BY id DESC";
