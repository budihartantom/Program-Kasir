...
<html>
    ...
    <body>
		<div class="content">
			...
			<br></br>
			<br></br>
			<h2>Withdraw SB 1288 / Bakarat</h2>
			<h4>Silahkan pilih menu untuk penginputan</h4>
			<form name="lompat">
			<select name="menu">
			<option value="?withdraw_game_sb1288">Kas</option>
			<option value="?transfer_withdraw_game_sb1288">Transfer</option>
			
			<option value="?hutang_withdraw_game_sb1288">Hutang</option>
			</select>
