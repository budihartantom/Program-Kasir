...
if(isset($_POST['simpan'])){
 ...
 // $sql1 = "INSERT INTO kas_kecil SET
 ...
 //                inquiri = 'deposit'";
  ...
  $sql1= "INSERT INTO kas_kecil VALUES('','$rekening', '$jenis_kas', NULL,'$nominal','deposit', '$now')";
...
$database->query($sql1);
   ...
   // $sql3= "INSERT INTO kas_besar SET
   //              jenis_transaksi = '$jenis_transaksi',
   //              jenis_kas = '$jenis_kas',
   //              rekening = '$rekening',
   //              nominal = '$nominal',
 ...
 $sql3= "INSERT INTO kas_besar VALUES('','$rekening', '$jenis_kas', NULL,'$nominal','deposit', '$now')"; 
