...
?>     
            ...
            <tr>
                ...
                <td><?php echo  @rupiah($r2['rekening']); ?></td>
               
                <td></td>
                <td><?php echo $r2['inquiri']; ?></td>
                <td><?php echo $r2['inquiri']; ?></td>
            ...
            <tr>
                <td>GRAND TOTAL</td>
                <td>GRAND SALDO</td>
                <td><?php echo  @rupiah($r2['nominal']); ?></td>
                <td><?php echo  @rupiah($r2['nominal']); ?></td>
                <td><?php echo  @rupiah($pendapatan = $r2['nominal']-$r2['nominal']); ?></td>
                <td></td>
                <td></td>
            </tr>

            <?php
             if ($pendapatan < $r2['nominal'] ){
