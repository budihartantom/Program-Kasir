...
<button type="submit" name="simpan" class="btn btn-success mr-2">Deposit</button>
                  ...
                  <!-- <button type="submit" name="simpan" class="btn btn-success mr-2" onclick="return confirm('Mau di print apa engga?')? window.open('halamans/cetak_report/cetak_report_saldo_penghutang_all_detail.php'): void(0);">Deposit</button> -->
