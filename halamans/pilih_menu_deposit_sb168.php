...
<html>
    ...
    <body>
		<div class="content">
			...
			<br></br>
			<br></br>
			<h2>Deposit SB 168 / Slot Games</h2>
			<h4>Silahkan pilih menu untuk penginputan</h4>
			<form name="lompat">
			<select name="menu">
			<option value="?deposit_game_sb168">Kas</option>
			<option value="?transfer_deposit_game_sb168">Transfer</option>
			
			<option value="?hutang_deposit_game_sb168">Hutang</option>
			</select>
