...
<div class="container">
    <table id="example" class="display" style="width:100%">
          ...
          <center><h1>LAPORAN TRANSAKSI MUTASI KAS KE BANK</h1></center>
               <tr>
               <th>Nomor Urut</th>
...
$data = mysqli_query($database,"SELECT kas_kecil.id, kas_kecil.jenis_transaksi, kas_kecil.jenis_kas, kas_kecil.rekening, kas_kecil.nominal, kas_kecil.inquiri, kas_kecil.create_date, kas_kecil.nominal AS nominal_terkirim, kas_besar.id, kas_besar.jenis_transaksi, kas_besar.jenis_kas, kas_besar.rekening, kas_besar.nominal, kas_besar.inquiri, kas_besar.create_date, kas_besar.nominal AS nominal_terkirim, bank_akun.id, bank_akun.jenis_transaksi, bank_akun.nominal1, bank_akun.rekening, bank_akun.nominal AS nominal_diterima, bank_akun.date_updated  FROM (kas_kecil LEFT JOIN bank_akun ON kas_kecil.rekening=bank_akun.rekening) LEFT JOIN kas_besar ON bank_akun.rekening=kas_besar.rekening");
...
<!-- <p>
    <a href="halamans/report_mutasi/cetak_report_mutasi_kas_kecil_ke_bank.php" class="btn btn-success btn-lg">
