...
//     while($d = mysqli_fetch_array($data)){
 ...
 $data = mysqli_query($database,"SELECT id, id_penghutang, SUM(nominal1) AS total_deposit, SUM(nominal) AS total_withdraw, inquiri, date_updated FROM bank_hutang where id_penghutang='$id_penghutang'");
    while($d = mysqli_fetch_array($data)){
      ?>
...
<p align="center">
  <!-- <a href="halamans/report_mutasi/cetak_report_detail_histori_penghutang.php" class="btn btn-success btn-lg">
      <span class="glyphicon glyphicon-print"></span>Cetak</a> -->
     
  <a href="http://192.168.1.10/program_kasir/?hutang_deposit_game_mm" class="btn btn-success btn-lg">
