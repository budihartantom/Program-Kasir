...
if($_POST['jenis_kas']==1){
   ...
   $sql2= "INSERT INTO kas_kecil VALUES('', '$jenis_pengeluaran','$jenis_kas','$rekening','$nominal','$inquiri', '$now')";

    $sql3= "INSERT INTO pengeluaran VALUES('', '$jenis_pengeluaran','$jenis_kas','$nominal','$rekening','$keterangan','$inquiri', '$now')";
   ...
   $sql4= "INSERT INTO kas_besar VALUES('', '$jenis_pengeluaran','$jenis_kas','$rekening','$nominal','$inquiri', '$now')";
   $sql5= "INSERT INTO pengeluaran VALUES('', '$jenis_pengeluaran','$jenis_kas','$nominal','$rekening','$keterangan','$inquiri', '$now')";
