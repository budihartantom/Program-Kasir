...
$no=1; 
$data = mysqli_query($database,"SELECT transaksi_bank_akun_depo.id, transaksi_bank_akun_depo.rekening, transaksi_bank_akun_depo.nominal, transaksi_bank_akun_depo.inquiri, transaksi_bank_akun_depo.date_updated, transaksi_bank_akun_with.id, transaksi_bank_akun_with.rekening, transaksi_bank_akun_with.nominal, transaksi_bank_akun_with.inquiri, transaksi_bank_akun_with.date_updated, bank_account.id_bank, bank_account.account_name, bank_account.account_number, SUM(transaksi_bank_akun_depo.nominal) AS total_deposit, SUM(transaksi_bank_akun_with.nominal) AS total_withdraw from (transaksi_bank_akun_depo INNER JOIN bank_account on transaksi_bank_akun_depo.rekening=bank_account.rekening) INNER JOIN transaksi_bank_akun_with on transaksi_bank_akun_with.rekening=bank_account.rekening");
...
//$no=1; 
//$data1 = mysqli_query($database,"SELECT transaksi_bank_akun_with.id, transaksi_bank_akun_with.rekening, transaksi_bank_akun_with.nominal, transaksi_bank_akun_with.inquiri, transaksi_bank_akun_with.date_updated, bank_account.id_bank, bank_account.account_name, bank_account.account_number, SUM(transaksi_bank_akun_with.nominal) AS total_withdraw from transaksi_bank_akun_with, bank_account WHERE transaksi_bank_akun_with.rekening=bank_account.rekening");
