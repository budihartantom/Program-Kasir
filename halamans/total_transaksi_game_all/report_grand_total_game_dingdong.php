...
$id=1;
// $rekening='rekening'; 
$data1 = mysqli_query($database,"SELECT id, jenis_transaksi, jenis_kas, rekening, nominal, inquiri, create_date FROM game_dingdong GROUP BY create_date");
...
<p>
    <a href="halamans/cetak_report/cetak_report_transaksi_game_dingdong.php" class="btn btn-success btn-lg">
