...
if($_POST['jenis_pemasukan']==1){
   ...
   $sql2= "INSERT INTO pemasukan_game_mm VALUES('', '$jenis_pemasukan','$jenis_kas','$rekening', '$nominal','$keterangan','$inquiri', '$now')";
   $sql3= "INSERT INTO game_mm VALUES('', '$jenis_pemasukan','$jenis_kas','$rekening','$nominal','$keterangan','$inquiri', '$now')";
