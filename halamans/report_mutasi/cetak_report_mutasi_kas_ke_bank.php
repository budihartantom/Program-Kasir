...
$data = mysqli_query($database,"SELECT bank_akun.jenis_transaksi, bank_akun.rekening, bank_akun.nominal1 AS nominal_terkirim, bank_akun.nominal AS nominal_diterima, bank_akun.date_updated FROM bank_akun WHERE jenis_transaksi !=0");
