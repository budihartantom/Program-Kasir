...
?></select>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="submit" name="simpan" class="btn btn-success mr-2"  onclick="cek()" id="pesan">Deposit</button>
...
<!-- <script>
  function konfirmasi(){
        var yakin = confirm("Apakah kamu yakin untuk mencetak?");

        if (yakin) {
            window.location = "http://localhost/program_kasir/detail_histori_penghutang.php?id_penghutang=<?php //echo $d['id_penghutang']; ?>";
        } else {
            window.location = "/program_kasir/?home";
        }
...
<!--     <a href="#" onclick="cek();">Demo membuat notifikasi</a> -->
    </body>

    <!-- <script>
      function konfirmasi(){
         var tanya = confirm("Apakah Anda Akan Mencetak Data Ini ?");
