...
<div class="container">
    <table id="example" class="display" style="width:100%">
        ...
        <tr>
          <center><h1>LAPORAN HISTORI BANK</h1></center>
                <th>Nomor Urut</th>
                <th>Kode Rekening</th>
...
//     while($d = mysqli_fetch_array($data)){
 ...
 $data = mysqli_query($database,"SELECT id, rekening, SUM(nominal) AS total_deposit, SUM(nominal1) AS total_withdraw, inquiri, date_updated FROM bank_akun where rekening='$rekening'");
    while($d = mysqli_fetch_array($data)){
      ?>
...
<p align="center">  
    <!--   <span class="glyphicon glyphicon-print"></span> Tekan : Ctrl+P (Untuk Cetak)
    &nbsp; -->
  <a href="http://192.168.1.10/program_kasir/?transfer_deposit_game_mm" class="btn btn-success btn-lg">
      <span class="glyphicon glyphicon-cancel"></span> Kembali Ke Home
    </a>
  </p>
<!-- <p>
    <a href="halamans/cetak_report/cetak_detail_histori_bank.php" class="btn btn-success btn-lg">
