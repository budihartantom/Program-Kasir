...
function format_ribuan ($nilai){
  ...
  $nominal=0;
  $sqlTampil1= "SELECT id,  jenis_kas, rekening, nominal, inquiri, create_date, SUM(nominal) AS nominal from game_dingdong WHERE inquiri='withdraw' AND jenis_kas='1'";
...
<?php if ($tampil1->num_rows > 0) {
  ...
  $nominal=0;
  $sqlTampil= "SELECT id, jenis_kas, rekening, nominal, inquiri, create_date, SUM(nominal) AS nominal from game_dingdong WHERE inquiri='deposit' AND jenis_kas='1'";
