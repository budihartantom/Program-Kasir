...
if(isset($_POST['simpan'])){
  ...
  $sql= "INSERT INTO bank_account VALUES('', '$jenis_transaksi', '$jenis_kas', '$account_name', '$rekening', '$nominal', '$saldo', '$inquiri', '$now')";
...
while($r2=mysqli_fetch_assoc($query2)){
    ...
    echo ">".$r2['account_name']." - ".$r2['rekening']." - ".$r2['nama_bank']."</option>";
}
?></select>
                            </select>
                          </div>
