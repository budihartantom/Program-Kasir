...
if(isset($_POST['simpan'])){
  ...
  $rekening = 0;
   $nominal=$_POST['nominal'];
    ...
    // $sql4= "INSERT INTO penghutang VALUES('','$id_penghutang','$nominal',NULL,'$hasil','$inquiri','$now')";
...
//                       FROM bank_hutang INNER JOIN transaksi_bank_hutang_with ON bank_hutang.id_penghutang = transaksi_bank_hutang_with.id_penghutang WHERE WHERE inquiri='withdraw' AND id_penghutang = $id_penghutang");
...
//    $nominal = $row['nominal'] - $nominal;
  ...
  $sql2= "INSERT INTO bank_hutang VALUES('','$jenis_transaksi','$id_penghutang','$nominal',NULL,'$hasil','$inquiri','$now')";

$sql3= "INSERT INTO transaksi_bank_hutang_with VALUES('','$id_penghutang', '$jenis_kas','$nominal', '$inquiri', '$now')";
