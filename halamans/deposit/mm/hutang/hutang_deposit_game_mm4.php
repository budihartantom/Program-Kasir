...
$sql3= "INSERT INTO transaksi_bank_hutang_depo VALUES('','$id_penghutang', '$jenis_kas','$nominal', '$inquiri', '$now')";
 ...
 if($sql3){
  echo "<script>alert('Deposit Berhasil Tersimpan, Apakah Anda Ingin Mencetak?...');location.href='index.php'</script>";
  } else {
   echo  "<script>alert('Coba Lagi..');location.href='index.php'</script>";
...
?></select>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <button type="submit" name="simpan" class="btn btn-success mr-2"  onclick="return confirm('Apakah Anda Ingin Mencetaknya?')? window.open('http://192.168.1.10/program_kasir/detail_histori_penghutang.php?id_penghutang=<?php echo $d['id_penghutang']; ?>'): void(0);">Deposit</button>
                        <!-- <button type="reset" class="btn btn-light">Reset</button> -->


 <!-- <td><a href="hapus_data_pemain.php?id=<?php// echo $d['id']; ?>" onclick="return confirm('Hapus Data Pemain?');" class="badge badge-danger">delete</a></td> -->
