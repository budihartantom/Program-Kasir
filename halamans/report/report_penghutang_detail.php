...
$data = mysqli_query($database,"SELECT transaksi_bank_hutang_depo.id, transaksi_bank_hutang_depo.id_penghutang, transaksi_bank_hutang_depo.nominal, transaksi_bank_hutang_depo.inquiri, transaksi_bank_hutang_depo.date_updated, transaksi_bank_hutang_depo.nominal AS nominal_deposit, transaksi_bank_hutang_with.id, transaksi_bank_hutang_with.id, transaksi_bank_hutang_with.id_penghutang, transaksi_bank_hutang_with.nominal, transaksi_bank_hutang_with.inquiri, transaksi_bank_hutang_with.date_updated, transaksi_bank_hutang_with.nominal AS nominal_withdraw from transaksi_bank_hutang_depo, transaksi_bank_hutang_with WHERE transaksi_bank_hutang_depo.id_penghutang=transaksi_bank_hutang_with.id_penghutang GROUP BY transaksi_bank_hutang_depo.id_penghutang DESC");
...
?> -->
        ...
        <!--        <td><?php//s echo @rupiah($d['nominal']); ?></td> -->
               <td><?php echo @rupiah($d['nominal_deposit']); ?></td>
            <td><?php echo @rupiah($d['nominal_deposit']); ?></td> 
            <td><?php echo @rupiah($d['nominal_deposit']-$d['nominal_deposit']); ?></td>
