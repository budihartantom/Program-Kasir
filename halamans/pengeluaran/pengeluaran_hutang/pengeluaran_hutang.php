...
if(isset($_POST['simpan'])){
   ...
   $sql2= "INSERT INTO bank_hutang VALUES('','$id_penghutang','$nominal',NULL,'$hasil','$inquiri','$now')";
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <select required aria-requiered="true" class="form-control" name="id_penghutang"> 
