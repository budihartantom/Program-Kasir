...
if(isset($_POST['simpan'])){
  ...
  if($_POST['rekening'] == 'B0001'){
  $sql= "INSERT INTO bank_akun VALUES('','$rekening', '$nominal', '$jenis_transaksi', NULL, '$hasil','$inquiri', '$now')";

  // $sql1 = "INSERT INTO bank_hutang SET
  ...
  $sql1= "INSERT INTO bank_hutang VALUES('','$rekening','$id_penghutang',NULL,'$nominal','$hasil','$inquiri','$now')";
...
$database->query($sql1);
   ...
   $sql2= "INSERT INTO bank_akun VALUES('','$rekening', '$nominal', '$jenis_transaksi', NULL, '$hasil','$inquiri', '$now')";
   ...
   $sql3= "INSERT INTO bank_hutang VALUES('','$rekening','$id_penghutang',NULL,'$nominal','$hasil','$inquiri','$now')";
