...
$nominal=0;
$sqlTampil1= "SELECT id, id_penghutang, jenis_kas, nominal_with, saldo, inquiri, date_updated, SUM(nominal_with) AS nominal_withdraw from transaksi_bank_hutang_with";
...
$sqlTampil= "SELECT id, id_penghutang, jenis_kas, nominal_depo, saldo, inquiri, date_updated, SUM(nominal_depo) AS nominal_deposit from transaksi_bank_hutang_depo";
